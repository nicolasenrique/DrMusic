...
CREATE TABLE IF NOT EXISTS `drmusic`.`product` (
  ...
  PRIMARY KEY (`id_product`, `id_category`, `id_colors`),
  ...
  CONSTRAINT `fk_products_prod_category1`
    ...
    REFERENCES `drmusic`.`prod_category` (`id_category`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE INDEX `fk_products_prod_category1_idx` ON `drmusic`.`product` (`id_category` ASC) VISIBLE;
...
CREATE INDEX `fk_prod_price_products1_idx` ON `drmusic`.`prod_price` (`id_products` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `drmusic`.`prod_image` (
  ...
  `order` INT NULL,
  `id_products` INT NOT NULL,
  PRIMARY KEY (`id_prod_image`, `id_products`),
...
CREATE INDEX `fk_prod_images_products1_idx` ON `drmusic`.`prod_image` (`id_products` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `drmusic`.`invoice_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `drmusic`.`invoice_type` ;

CREATE TABLE IF NOT EXISTS `drmusic`.`invoice_type` (
...
CREATE TABLE IF NOT EXISTS `drmusic`.`prod_size` (
  ...
  CONSTRAINT `fk_prod_size_product1`
...
CREATE INDEX `fk_prod_size_product1_idx` ON `drmusic`.`prod_size` (`id_product` ASC) VISIBLE;
